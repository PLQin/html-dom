...
const PostList: Post[] = [
    ...
    { slug: 'create-a-range-slider', zh: "创建一个区域滑块", level: 'Advanced', zhLevel: '基础' },
    { slug: 'create-an-element', zh: '创建一个元素', level: 'Basic', zhLevel: '基础' },
    { slug: 'create-an-image-comparison-slider', zh: "创建一个图像比较滑块", level: 'Advanced', zhLevel: '基础' },
    { slug: 'create-one-time-event-handler', zh: '创建一次性的事件处理', level: 'Basic', zhLevel: '基础' },
    { slug: 'create-resizable-split-views', zh: '创建可调整大小的拆分视图', level: 'Advanced', zhLevel: '高级', },
    ...
    { slug: 'drag-and-drop-table-column', zh: '拖动表格列', level: 'Advanced', zhLevel: '高级', },
    ...
    { slug: 'print-an-image', zh: '打印图片', level: 'Intermediate', zhLevel: '中级' },
    ...
    { slug: 'scroll-to-an-element', zh: '滚动到某一个元素', level: 'Basic', zhLevel: '基础' },
    ...
    { slug: 'show-a-loading-indicator-when-an-iframe-is-being-loaded', zh: "当加载 iframe 时显示 loading 提示", level: 'Intermediate', zhLevel: '中级' },
